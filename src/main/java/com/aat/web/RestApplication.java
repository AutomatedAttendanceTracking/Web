...
public class RestApplication extends Application{
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach("/bonus/{studentNumber}", BonusResource.class);	// returns if the student has the bonus
        // POST
        ...
        router.attach("/clear/participations", ParticipationResource.class);	//deletes all qrCodes
